                    ...
                    <div className="contact-icons">
                        ...
                        <div className="contact-top-row">
                            <a href="mailto:juliavanclower@gmail.com" target="_blank">
                                <img alt="email icon" src="/circle-email-icon.png"/> <h3>JuliaVanClower@gmail.com</h3>
                            </a>
                            <a href="https://github.com/JuliaClower" target="blank">
                                <img alt="github icon" src="/github-icon.png" /> <h3>github.com/JuliaClower</h3>
                            </a>
                        </div>
                        <div className="contact-bottom-row">
                            <a href="https://www.linkedin.com/in/juliavanclower/" target="blank">
                                <img alt="linkedin icon" src="/linkedin-icon.png" /> <h3>linkedin.com/in/juliavanclower/ </h3>
                            </a>
                            <a href="https://docs.google.com/document/d/1Uga481QOGNLg1TlUHGwxAzg9iQajox58en0XweD30_U/edit?usp=sharing" target="blank">
                                <img alt="resume icon" src="/resume.png" /> <h3> Download a copy of my resume.</h3>
                            </a>
                        </div>
                    </div>
                </div>
